//
//  LatestComicSectionHeader.swift
//  xkcd Browser
//
//  Created by Eric Davis on 02/02/2022.
//

import UIKit

final class LatestComicSectionHeaderView: UICollectionReusableView {
   static let reuseIdentifier = "LatestComicHeaderIdentifier"
